...
build/bench: build/main.o build/gemm_asm.o
	@mkdir -p build
	OPENBLAS_NUM_THREADS=$(OPENBLAS_NUM_THREADS) nvcc -o build/bench build/main.o build/gemm_asm.o \
    -arch=$(TARGET) $(CXXFLAGS)
